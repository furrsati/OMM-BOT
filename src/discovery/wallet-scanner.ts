        ...
        if (existingResult.rows.length > 0) {
          ...
          await query(
            `INSERT INTO smart_wallets
             (id, address, tier, score, win_rate, average_return, tokens_entered,
              last_active, total_trades, successful_trades, average_hold_time, is_active, created_at, updated_at)
